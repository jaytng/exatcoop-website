...
class GalleryManager
{
	...
	public static function upload($file, $upload_settings, $media_uploader_file_data, $resizeSettings)
	{
		...
		if ($resizeSettings['original_image_resize'])
		{
			...
			{
				if ($resizeSettings['original_image_resize_height'])
				{
	...
	*/
	...
	public static function deleteTagFromFieldsValues($tag_id = null, $context = '')
	{
		...
		if ($context === '')
		{
			self::deleteTagCustomFieldsByTagId($tag_id);
			self::deleteTagSubformCustomFieldsByTagId($tag_id);
		}
	}
	 ...
	 * @return  void
	 */
	private static function deleteTagCustomFieldsByTagId($tag_id = null)
	{
		if (!$tag_id)
		{
			return;
	 ...
	 * @return  void
	 */
	private static function deleteTagSubformCustomFieldsByTagId($tag_id = null)
	{
		if (!$tag_id)
		{
			return;
