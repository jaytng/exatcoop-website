...
class SmartSlider3Info {
    ...
    public static $version = '3.5.1.22';

    public static $channel = 'stable';

    public static $revision = '8f12fee65f3f71daba53c95525b2eb4e351b9c4c';

    public static $revisionShort = '8f12fee6';

    public static $branch = 'release-3.5.1.22';
